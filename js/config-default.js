/* Centralized portfolio data. The editor modifies this shape; the backend validates it. */
window.DEFAULT_PORTFOLIO = {
  ...
  "hero": {
    ...
    "subtitle": "I'm Maya, a product designer and frontend developer in Portland. I help small teams turn rough ideas into polished, accessible interfaces — from first sketch to shipped CSS.",
  ...
  "projects": [
    {
      ...
      "description": "Led design for a lightweight analytics dashboard. Simplified 20+ charts into 6 opinionated views. Trial-to-paid conversion went up 18% after launch.",
    ...
    },
    {
      ...
      "description": "Redesigned a plant shop's storefront and checkout. Rebuilt in semantic HTML with a 0.9s LCP on mid-range phones. Bounce rate dropped by a third.",
    ...
    },
    {
      ...
      "description": "A small, dependency-free component kit with 30+ accessible components and design tokens. 2.4k stars and used by a handful of indie teams.",
  ...
  "experience": [
    { "id": "e-1", "role": "Senior Product Designer", "company": "Northwind Studio", "period": "2022 — Now", "location": "Portland / Remote", "summary": "Own design for two SaaS products. Built the studio's token pipeline and mentor two junior designers." },
    { "id": "e-2", "role": "Design Engineer", "company": "Loopwork", "period": "2019 — 2022", "location": "Remote", "summary": "Sat between design and frontend. Shipped marketing site, onboarding flows, and a component library used by 4 teams." },
    { "id": "e-3", "role": "UI Designer", "company": "Fieldnotes", "period": "2017 — 2019", "location": "Seattle", "summary": "Designed mobile and web features for a journaling app with 200k readers. Ran usability tests every other week." }
  ],
  "education": [
    { "id": "ed-1", "school": "University of Washington", "degree": "B.A. in Interaction Design", "period": "2013 — 2017", "note": "Focus on human-centered design. Thesis on readability of long-form reading on mobile." }
  ],
